...
func (in *LibvirtSpec) DeepCopyInto(out *LibvirtSpec) {
	*out = *in
	if in.Overrides != nil {
		...
		*out = make(openstackv1alpha1.HelmOverrides, len(*in))
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Openvswitch) DeepCopyInto(out *Openvswitch) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Openvswitch.
func (in *Openvswitch) DeepCopy() *Openvswitch {
	if in == nil {
		return nil
	}
	out := new(Openvswitch)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *Openvswitch) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpenvswitchList) DeepCopyInto(out *OpenvswitchList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]Openvswitch, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OpenvswitchList.
func (in *OpenvswitchList) DeepCopy() *OpenvswitchList {
	if in == nil {
		return nil
	}
	out := new(OpenvswitchList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *OpenvswitchList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpenvswitchSpec) DeepCopyInto(out *OpenvswitchSpec) {
	*out = *in
	if in.Overrides != nil {
		in, out := &in.Overrides, &out.Overrides
		*out = make(openstackv1alpha1.HelmOverrides, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OpenvswitchSpec.
func (in *OpenvswitchSpec) DeepCopy() *OpenvswitchSpec {
	if in == nil {
		return nil
	}
	out := new(OpenvswitchSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpenvswitchStatus) DeepCopyInto(out *OpenvswitchStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OpenvswitchStatus.
func (in *OpenvswitchStatus) DeepCopy() *OpenvswitchStatus {
	if in == nil {
		return nil
	}
	out := new(OpenvswitchStatus)
	in.DeepCopyInto(out)
	return out
}
